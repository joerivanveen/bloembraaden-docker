...
// Rewriterules that fire index.php are in /etc/httpd/conf/httpd.conf
require __DIR__ . '/../core/Require.php';
// run install / upgrade if requested
if ((Setup::$INSTALL)) Help::Install(new DB());
...
// TODO: duidelijk maken dat je niet hoeft te saven
// TODO: als je een pagina toevoegt vanuit het LINK menu, dan ook die linken meteen aan de oorspronkelijke pagina
// Respond
